...
public class YahtzeeGame
{
	...
	*/
	...
	private void chooseFrozen()
	{
		...
		if(frozenDie.indexOf('2') > -1){ die2.freezeDie(); }
		if(frozenDie.indexOf('3') > -1){ die3.freezeDie(); }
		if(frozenDie.indexOf('4') > -1){ die4.freezeDie(); }
		if(frozenDie.indexOf('5') > -1){ die5.freezeDie(); }
	}
	...
	private void markScore()
	{
		...
		System.out.println("5. Fives   11. Large Straight");
